...
exports.run = async (client, message, args, ops) => {
    ...
    .setColor('RANDOM')
    .setTitle('Erreur')
    .setDescription('Il n\'y a actuellement pas de musique dans Drakaria Network')
    ...
    .setColor('RANDOM')
    .setTitle('Erreur')
    .setDescription('Cette musique est déjà en pause !')
    .setTimestamp(new Date())
    .setFooter(`Demandé par ${message.author.tag}`);
    ...
    .setColor('RANDOM')
    .setTitle('Info')
    .addField('Mis en pause avec succès de ', fetched.queue[0].songTitle)
    .setTimestamp(new Date())
    .setFooter(`Demandé par ${message.author.tag}`);
